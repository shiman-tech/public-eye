...
-- 7. Seed some sample data (optional)
INSERT INTO reports (title, description, category, status, address, lat, lng, reported_by) VALUES
  ('Large pothole on Main St', 'Deep pothole causing tire damage near the intersection', 'Pothole', 'Open', 'Main Street, Downtown', 40.7128, -74.0060, 'citizen1@example.com'),
  ('Broken streetlight', 'Streetlight has been out for 3 weeks, safety concern at night', 'Streetlight', 'In Progress', 'Oak Avenue, Midtown', 40.7580, -73.9855, 'Anonymous'),
  ('Garbage overflow', 'Bins overflowing near the park entrance', 'Sanitation', 'Resolved', 'Central Park North, Uptown', 40.7829, -73.9654, 'Anonymous');
